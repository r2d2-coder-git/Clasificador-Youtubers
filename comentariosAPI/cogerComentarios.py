...
def coger_videos(conn, playlist_id, num_videos):
    ...
    # for i in range(num_videos):
       # Try por si el canal no tiene videos
    try:
...
def coger_comentarios(conn, id_videos, categoria, nombre_canal, comentarios_canal):
    ...
    for id_video in id_videos:
        print(id_video, com_video_actual)
        com_video_actual = 0
        try:
...
def main():
    ...
    #df = pd.DataFrame(columns=('topico', 'comentarios', 'canales_deseados', 'canales_conseguidos'))
        ...
        for num_comentarios in comentarios_canal:
            ...
            for categoria in topicos:
                ...
                for id_canal in canales_topicos:
                    ...
                    with open("canales_sin_leer-dibujo.txt", "w") as output:
                    ...
                    titulos_videos, id_videos = coger_videos(
                    ...
                    if cantidad_comentarios == num_comentarios:
                        ...
                        with io.open('./redNeuronal/data/comentarios.csv', "a", encoding="utf-8", newline="") as comments_file:
                            comments_writer = csv.writer(comments_file)
